...
if (Platform.OS === 'android') {
    var AndroidTextInput = requireNativeComponent('MSMaskInput', null);
} else if (Platform.OS === 'ios') {
    var RCTTextView = requireNativeComponent('RCTTextView', null);
    var RCTTextField = requireNativeComponent('MSMaskInput', null);
}
 ...
 */
var MSTextInput = React.createClass({
        statics: {
...
componentDidMount: function() {
    if (Platform.OS === 'android' && DeviceEventEmitter.addListener) {
        let self = this;
        DeviceEventEmitter.addListener('keyboardDidHide', function(e: Event) {
            self.refs["input"].blur && self.refs["input"].blur();
        });
    }
    if (!this.context.focusEmitter) {
        if (this.props.autoFocus) {
            this.requestAnimationFrame(this.refs["input"].focus);
        }
        return;
    }
...
componentWillUnmount: function() {
    if (Platform.OS === 'android' && DeviceEventEmitter.removeAllListeners) {
