...
var WebView = React.createClass({
    ...
    propTypes: {
        ...
        onChangePullRefresh: PropTypes.func,
        /**
    ...
    var webView =
        <MSWebView
            ...
            onChangePullRefresh={this.props.onChangePullRefresh}
            />;
    ...
    onChange: function(event) {
        ...
        this.props.onShouldStartLoadWithRequest && this.props.onShouldStartLoadWithRequest(obj);
    },
});

var MSWebView = requireNativeComponent('MSWebView', WebView, {
    nativeOnly: {
        onLoadingStart: true,
        onLoadingError: true,
