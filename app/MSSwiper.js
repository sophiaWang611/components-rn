...
var _reactNative2 = require('react');
...
exports['default'] = _reactNative2.createClass({
    displayName: 'index',
     ...
     */
    propTypes: {
        horizontal: _reactNative2.PropTypes.bool,
        children: _reactNative2.PropTypes.node.isRequired,
        style: _reactNative.View.propTypes.style,
        pagingEnabled: _reactNative2.PropTypes.bool,
        showsHorizontalScrollIndicator: _reactNative2.PropTypes.bool,
        showsVerticalScrollIndicator: _reactNative2.PropTypes.bool,
        bounces: _reactNative2.PropTypes.bool,
        scrollsToTop: _reactNative2.PropTypes.bool,
        removeClippedSubviews: _reactNative2.PropTypes.bool,
        automaticallyAdjustContentInsets: _reactNative2.PropTypes.bool,
        showsPagination: _reactNative2.PropTypes.bool,
        showsButtons: _reactNative2.PropTypes.bool,
        loop: _reactNative2.PropTypes.bool,
        autoplay: _reactNative2.PropTypes.bool,
        autoplayTimeout: _reactNative2.PropTypes.number,
        autoplayDirection: _reactNative2.PropTypes.bool,
        index: _reactNative2.PropTypes.number,
        renderPagination: _reactNative2.PropTypes.func
    },
    ...
    autoplay: function autoplay() {
        ...
        if (Platform.OS === 'android') {
            ...
            this.autoplayTimer = this.setInterval(function () {
                ...
                var offset = {};
                offset[_this.state.dir] = 192 + _this.state.index*_this.props.height;
                _this.updateIndex(offset, _this.state.dir);
    ...
    renderPagination: function renderPagination() {
        ...
        for (var i = 0; i < this.state.total; i++) {
            dots.push(i === this.state.index ? this.props.activeDot || _reactNative2.createElement(_reactNative.View, { style: {
                ...
                marginTop: 3,
                marginBottom: 3
            } }) : this.props.dot || _reactNative2.createElement(_reactNative.View, { style: {
        ...
        return _reactNative2.createElement(
            _reactNative.View,
    ...
    renderTitle: function renderTitle() {
        ...
        return title ? _reactNative2.createElement(
            _reactNative.View,
            { style: styles.title },
    ...
    renderNextButton: function renderNextButton() {
        ...
        if (this.props.loop || this.state.index != this.state.total - 1) {
            button = this.props.nextButton || _reactNative2.createElement(
                    _reactNative.Text,
    ...
    renderPrevButton: function renderPrevButton() {
        ...
        if (this.props.loop || this.state.index != 0) {
            button = this.props.prevButton || _reactNative2.createElement(
                    _reactNative.Text,
                    { style: styles.buttonText },
                    '‹'
                );
    ...
    render: function render() {
        ...
        } else pages = _reactNative2.createElement(
            _reactNative.View,
            { style: pageStyle },
            children
        );
