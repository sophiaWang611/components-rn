...
const MSComponents = {
    ...
    get MSRefreshableList() { return require('./app/MSRefreshableListView'); },
    get MSRefreshableScroll() { return require('./app/MSRefreshableScrollView'); },
    ...
    get MSLoading() { return require('./app/MSLoadingView'); },
    get MSMapView() { return require('./app/MSMapView'); },
    get MSPhotoPicker() { return require('./app/MSPhotoPicker'); },
    get MSRadio() { return require('./app/MSRadioView'); },
    get MSScrollableTabView() { return require('./app/MSScrollableTabView'); },
    get MSSearchBar() { return require('./app/MSSearchBar'); },
    get MSSwiper() { return require('./app/MSSwiperView'); },
    get MSSwitch() { return require('./app/MSSwitchView'); },
    get MSTextArea() { return require('./app/MSTextAreaView'); },
